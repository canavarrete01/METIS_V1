...
# ----------------------------------------------------------------------------------------------
# 30 species in adam's abundance tables
fullspecieslist = ['H2', 'He', 'CH4', 'CO', 'N2', 'NH3', 'H2O', 
                  'PH3', 'H2S', 'TiO', 'VO', 'CaH', 'MgH', 'Li', 
                  'Na', 'K', 'Rb', 'Cs', 'FeH', 'CrH', 'H-', 'H', 
                  'H+', 'e-', 'Fe', 'SiO', 'CaOH','TiH', 'Al', 'Ca']
    
speciesdict = dict(zip(fullspecieslist,range(len(fullspecieslist))))

# molar masses in g/mol
molarmassdict={ 'H2':2.01588, 'He':4.002602, 'CH4':16.04, 'CO':28.01, 
...
for spec,k in zip(fullspecieslist,range(30)):
